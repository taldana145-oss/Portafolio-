...
registerOnClick('foto 1', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam01', 'camlookup01', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto 2', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam02', 'camlookup02', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto 3', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam03', 'camlookup03', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto 4', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam04', 'camlookup04', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto 5', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam05', 'camlookup05', 1, function() {}, 1);
}, function(event) {});
